function elFinderInit(connector_url){

  var elfNode, elfInstance, dialogName,
    elfUrl = connector_url, // Your connector's URL
...
elFinderInit(connector_url);

CKEDITOR.replace('s3-adapter',{
  filebrowserBrowseUrl: '#',
  extraPlugins: 'uploadimage,image2',
  filebrowserUploadUrl: connector_url,
  imageUploadUrl: connector_url
});
